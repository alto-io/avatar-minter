...
export class JSOra {
    ...
    _children = [];
    _children_elems = new WeakMap();
    _children_uuids = {};
    _isolate_non_opaque_groups = false;
    _loading_callback_function = null;
    _loading_callback_layers = {};
    _extracted_zip_srcs = new WeakMap();
    root = {}
    _root_group = {}
    ...
    get_by_path = function(path){
        ...
        let current_group = this._root_group;
